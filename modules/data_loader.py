...
def load_data():
    azure = pd.read_csv("https://raw.githubusercontent.com/keshavmurthyhg/vce-digital-ops-platform-prod/main/data/All-VCE-Bugs.csv")
    snow = pd.read_excel("https://raw.githubusercontent.com/keshavmurthyhg/vce-digital-ops-platform-prod/main/data/Snow-incident.xlsx", engine="openpyxl")
    ptc = pd.read_csv("https://raw.githubusercontent.com/keshavmurthyhg/vce-digital-ops-platform-prod/main/data/PTC-Cases-Report.csv")
